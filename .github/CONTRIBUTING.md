...
```
git clone git@github.com:your-username/cordova-plugin-fs-speech-synthesis.git
```
...
git remote add upstream https://github.com/FisherleaSystems/cordova-plugin-fs-speech-synthesis.git
```
